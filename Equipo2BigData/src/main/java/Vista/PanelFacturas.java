...
public class PanelFacturas extends JPanel {
	...
	public PanelFacturas(ControladorPanelFacturas controladorPanelFacturas) {
		...
		textFieldFecha.setBounds(299, 117, 114, 20);
		add(textFieldFecha);
		...
		textNIF.setBounds(582, 117, 113, 20);
		add(textNIF);
		textNIF.setColumns(10);

		textNombre = new JTextField();
		textNombre.setBounds(582, 148, 113, 20);
		add(textNombre);
		textNombre.setColumns(10);

		textApellido = new JTextField();
		textApellido.setBounds(582, 179, 113, 20);
		add(textApellido);
		textApellido.setColumns(10);

		textFieldNumTrans = new JTextField();
		textFieldNumTrans.setBounds(299, 148, 114, 20);
		...
		lblNIF.setBounds(476, 117, 67, 20);
		add(lblNIF);

		JLabel lblNombre = new JLabel("Nombre:");
		lblNombre.setFont(new Font("Arial", Font.BOLD, 16));
		lblNombre.setBounds(476, 150, 82, 17);
		add(lblNombre);

		JLabel lblApellido = new JLabel("Apellido:");
		lblApellido.setFont(new Font("Arial", Font.BOLD, 16));
		lblApellido.setBounds(476, 181, 82, 17);
		add(lblApellido);

		JLabel lblTransaccion = new JLabel("N\u00BA Transacci\u00F3n:");
		lblTransaccion.setFont(new Font("Arial", Font.BOLD, 16));
		lblTransaccion.setBounds(139, 148, 150, 20);
		add(lblTransaccion);

		JScrollPane scrollPaneProductos = new JScrollPane();
		scrollPaneProductos.setBounds(545, 244, 150, 160);
		...
		scrollPaneAnnadidos.setBounds(139, 244, 300, 160);
		...
		btnAnnadir.setBounds(545, 459, 150, 25);
		add(btnAnnadir);
		...
		textCantidad.setBounds(655, 417, 40, 20);
		add(textCantidad);
		...
		lblFecha.setBounds(139, 117, 123, 20);
